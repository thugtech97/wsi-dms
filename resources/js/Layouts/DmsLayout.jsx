...
const ALL_NAV_ITEMS = [
    ...
    // Hidden on request — the page and its routes stay live, only the menu link is out.
    // { label: 'API Applications',icon: <PlugIcon />,      routeName: 'api-clients.index',    adminOnly: true },
...
/** Unused while the API Applications link is commented out of ALL_NAV_ITEMS. */
function PlugIcon() {
    return <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9 3v6M15 3v6M6 9h12v3a6 6 0 01-6 6 6 6 0 01-6-6V9zM12 18v3"/></svg>;
}
function BellIcon() {
